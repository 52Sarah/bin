...
. $HOME/.__login.debug ".bashrc__functions" || __echo() { :; }
__echo "[.bashrc__functions] starting"
...
bak() {
    ...
    # cp: -p preserve times, etc.; -n don't overwirte; -L all symlinks are followed; -R recursive
...
__echo "[.bashrc__functions] finished"
